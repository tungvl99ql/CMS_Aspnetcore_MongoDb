...
var KEY_LAYOUT = "KEY_LAYOUT";
var KEY_LIGHT = "KEY_LIGHT";
var KEY_DARK = "KEY_DARK";
$('.layout-setting').on("click", function (e) {
    ...
    if (document) {
        ...
        let layout = localStorage.getItem(KEY_LAYOUT);
        console.log("layout", layout)
    if (layout == KEY_DARK) {
        localStorage.setItem(KEY_LAYOUT, KEY_LIGHT);
      } else {
        localStorage.setItem(KEY_LAYOUT, KEY_DARK);
      }
    } else {
